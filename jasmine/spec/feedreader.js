...
$(function() {
    ...
    */
    ...
    describe("Initial Entries", function(){
        ...
        it("There is at least one .entry in the .feed container after LoadFeed function runs ", function(done){
    ...
    describe("New Feed Selection", function(){
        ...
        beforeEach(function(done) {
            setTimeout(function() {  //Waits for loadFeed to finish loading current feed.
                current = $('.feed a')[0]; //Save the current value of the first feed.
                loadFeed(1);// Load the next feed value.
                setTimeout(function(){done();},1000); //Waits for loadFeed to load new value.
            }, 1000);
        ...
        it("The content changes when new feed loads", function(done){
